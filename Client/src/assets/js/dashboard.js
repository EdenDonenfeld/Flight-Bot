...
function onloadfunction() {
    ...
    const messages = [
        ...
        'שלום שלום וברוך הבא! הגעת לצאטבוט שלנו, לכל דבר שתצטרך אני פה לעזור - מהזמנת טיסה עד לביטולה וכל מה שיש בינהם :)',
        'מה שלומך! ברוך הבא לצאטבוט! כל מה שתצטרך אני פה לעזור - מהזמנת טיסה עד לביטולה וכל מה שיש בינהם :)',
    ];
